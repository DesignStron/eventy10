-- COMPLETE FINAL SETUP FOR EVENTOWA SITE (FIXED)
...
-- Step 3: Create storage bucket for gallery images (only if not exists)
...
-- Step 4: Set up Row Level Security for storage (fixed - remove policies first if they exist)
DO $$
BEGIN
    -- Drop all existing policies for gallery-images bucket
...
-- Step 6: Add sample gallery images (optional)
DELETE FROM gallery;

INSERT INTO gallery (title, url, category, created_at) VALUES
('Urodziny Kasia', 'https://picsum.photos/seed/urodziny1/400/300.jpg', 'urodziny', NOW()),
('Firmowy Event', 'https://picsum.photos/seed/firmowe1/400/300.jpg', 'firmowe', NOW()),
('Szkolna Impreza', 'https://picsum.photos/seed/szkolne1/400/300.jpg', 'szkolne', NOW()),
('Wesele Ania i Tomek', 'https://picsum.photos/seed/wesela1/400/300.jpg', 'inne', NOW()),
('Komunia', 'https://picsum.photos/seed/komunie1/400/300.jpg', 'inne', NOW());
