-- Complete reset and setup of offer table with all data
-- RUN THIS TO RESET AND POPULATE OFFER TABLE

-- Step 1: Drop existing table and constraints
DROP TABLE IF EXISTS offer CASCADE;

-- Step 2: Create offer table with all allowed keys
CREATE TABLE offer (
